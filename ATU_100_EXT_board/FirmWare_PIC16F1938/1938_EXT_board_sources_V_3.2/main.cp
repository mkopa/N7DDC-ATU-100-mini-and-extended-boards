#line 1 "C:/Users/marci/Documents/ATU-100/N7DDC-ATU-100-mini-and-extended-boards-master/ATU_100_EXT_board/FirmWare_PIC16F1938/1938_EXT_board_sources_V_3.1/main.c"
#line 1 "c:/users/marci/documents/atu-100/n7ddc-atu-100-mini-and-extended-boards-master/atu_100_ext_board/firmware_pic16f1938/1938_ext_board_sources_v_3.1/oled_control.h"
...
#line 1 "c:/users/marci/documents/atu-100/n7ddc-atu-100-mini-and-extended-boards-master/atu_100_ext_board/firmware_pic16f1938/1938_ext_board_sources_v_3.1/pic_init.h"
...
void pic_init (void);
#line 1 "c:/users/marci/documents/atu-100/n7ddc-atu-100-mini-and-extended-boards-master/atu_100_ext_board/firmware_pic16f1938/1938_ext_board_sources_v_3.1/main.h"
...
#line 11 "C:/Users/marci/Documents/ATU-100/N7DDC-ATU-100-mini-and-extended-boards-master/ATU_100_EXT_board/FirmWare_PIC16F1938/1938_EXT_board_sources_V_3.1/main.c"
...
void show_loss(void) {
 ...
 work_str_2[1] = '.';
 work_str_2[2] = work_str[5];
 if(type==4 | type==5) led_wr_str (4, 6, work_str_2, 3);
 else if(type!=0) led_wr_str (1, 0, work_str_2, 3);
 return;
}

void load_settings() {
 cap = EEPROM_Read(255 - mem_offset * 5);
 ind = EEPROM_Read(254 - mem_offset * 5);
 SW = EEPROM_Read(253 - mem_offset * 5);
 swr_a = EEPROM_Read(252 - mem_offset * 5) * 256;
 swr_a += EEPROM_Read(251 - mem_offset * 5);
 set_ind(ind);
 set_cap(cap);
 set_sw(SW);
}
