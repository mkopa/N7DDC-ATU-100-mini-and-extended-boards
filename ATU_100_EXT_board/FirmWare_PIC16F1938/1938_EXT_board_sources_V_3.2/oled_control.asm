...
;oled_control.c,398 :: 		unsigned char Soft_I2C_Read () {
;oled_control.c,400 :: 		unsigned char readByte = 0;
...
;oled_control.c,402 :: 		Soft_I2C_Sda_Direction = 1;
	BSF        TRISB7_bit+0, 7
;oled_control.c,403 :: 		for(i=0; i<=7; i++) {
	CLRF       R1
L_Soft_I2C_Read92:
	MOVF       R1, 0
	SUBLW      7
...
;oled_control.c,404 :: 		readByte <<= 1;
	LSLF       Soft_I2C_Read_readByte_L0+0, 1
;oled_control.c,405 :: 		readByte &= 0xFE;
	MOVLW      254
	ANDWF      Soft_I2C_Read_readByte_L0+0, 1
;oled_control.c,406 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read95:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read95
	NOP
;oled_control.c,407 :: 		Soft_I2C_Scl_Direction = 1;
	BSF        TRISB6_bit+0, 6
;oled_control.c,408 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read96:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read96
	NOP
;oled_control.c,409 :: 		if (PORTB & 0x80) {
	BTFSS      PORTB+0, 7
	GOTO       L_Soft_I2C_Read97
;oled_control.c,410 :: 		readByte += 1;
	INCF       Soft_I2C_Read_readByte_L0+0, 1
;oled_control.c,411 :: 		}
L_Soft_I2C_Read97:
;oled_control.c,412 :: 		Soft_I2C_Scl_Direction = 0;
	BCF        TRISB6_bit+0, 6
;oled_control.c,413 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read98:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read98
	NOP
;oled_control.c,403 :: 		for(i=0; i<=7; i++) {
	INCF       R1, 1
;oled_control.c,414 :: 		}
...
L_Soft_I2C_Read93:
;oled_control.c,415 :: 		Soft_I2C_Sda_Direction = 1; //ACK
	BSF        TRISB7_bit+0, 7
;oled_control.c,416 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read99:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read99
	NOP
;oled_control.c,417 :: 		Soft_I2C_Scl_Direction = 1;
	BSF        TRISB6_bit+0, 6
;oled_control.c,418 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read100:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read100
	NOP
;oled_control.c,419 :: 		Soft_I2C_Scl_Direction = 0;
	BCF        TRISB6_bit+0, 6
;oled_control.c,420 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Read101:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Read101
	NOP
;oled_control.c,421 :: 		}
L_Soft_I2C_Read91:
;oled_control.c,423 :: 		return readByte;
...
;oled_control.c,426 :: 		void Soft_I2C_Stop () {
;oled_control.c,427 :: 		if(led_type!=0) {
	MOVF       oled_control_led_type+0, 0
	XORLW      0
	BTFSC      STATUS+0, 2
	GOTO       L_Soft_I2C_Stop102
;oled_control.c,428 :: 		Soft_I2C_Sda_Direction = 0;
	BCF        TRISB7_bit+0, 7
;oled_control.c,429 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Stop103:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Stop103
	NOP
;oled_control.c,430 :: 		Soft_I2C_Scl_Direction = 1;
	BSF        TRISB6_bit+0, 6
;oled_control.c,431 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Stop104:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Stop104
	NOP
;oled_control.c,432 :: 		Soft_I2C_Sda_Direction = 1;
	BSF        TRISB7_bit+0, 7
;oled_control.c,433 :: 		Delay_us(5);
	MOVLW      6
	MOVWF      R13
L_Soft_I2C_Stop105:
	DECFSZ     R13, 1
	GOTO       L_Soft_I2C_Stop105
	NOP
;oled_control.c,434 :: 		}
L_Soft_I2C_Stop102:
;oled_control.c,435 :: 		}
